...
async function regenerateMaterial(keywords, material, level = 2, subject, bab, quiz) {
	const level_list = {
		1: "materi disusun sesederhana mungkin, tidak ada kata-kata yang rumit dan sangat mudah dipahami oleh anak-anak, singkatnya materi dengan level pemahaman lebih mudah",
		2: "materi disusun dengan kata-kata yang relatif normal, dan materi disusun dengan bahasa yang lebih formal, singkatnya materi denan level pemahaman normal pada umunya",
		3: "materi disusun dengan lebih kompleks dengan bahasa yang lebih formal, materi lebih panjang dan luas, singkatnya materi dengan level pemahaman lebih kompleks",
	};
